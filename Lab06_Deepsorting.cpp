...
void draw() {	
	...
	FaceModel firstPolygon = {
		4, 4, z1, {A, B, C, D}, {f1, f2, f3, f4}, {1.0, 1.0, 0.0}
	};
	...
	FaceModel secondPolygon = {
		4, 4, z1, {A, B, C, D}, {f1, f2, f3, f4}, {1.0, 0.0, 0.0}
	};
	...
	FaceModel thirdPolygon = {
		3, 3, z1, {A, B, C}, {f1, f2, f3}, {0.0, 1.0, 0.0}
	};
...
int main(int argc, char **argv) {
	...
	glutCreateWindow("Thuat toan Depth Sorting");
